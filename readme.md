...
- [How to Buy Cryptocurrency](#How-to-Buy-Cryptocurrency)
    - [What to Look For in an Exchange](What-to-Look-For-in-an-Exchange)
        ...
        - [Deposit/Withdrawl Methods](Deposit/Withdrawl-Methods)
...
- [How to Create a Securing Personal Wallet](How-to-Create-a-Secure-Personal-Wallet)
    - [Hardware Keys](Hardware-Keys)
        ...
        - [Types of Hardware Keys](Types-of-Hardware-Keys)
    - [How and Where to Create Secure Wallets](How-and-Where-to-Create-Secure-Wallets)
        - [Wallet With Hardware Key](Wallet-With-Hardware-Key)
        - [Wallet Without Hardware Key](Wallet-Without-Hardware-Key)   
